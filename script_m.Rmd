...
```{r}
timeSeries = ts(data$y, frequency=7)
plot(timeSeries, type='l')
```
Données d'entrainement
```{r}
timeSeriesTest = ts(data$y[281:308], start = 41, frequency=7)
timeSeries = ts(data$y[1:280], frequency=7)
plot(timeSeries, type='l')
```
...
pred_val = exp(pred1$mean + mod1$sigma2)
