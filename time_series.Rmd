...
```
Les résidus ne sont toujours pas stationnaires visuellment car on distingue une périodicité. L'ACF conforme cette hypothèse par la périodicité de ses pics significatifs. De plus, d'après l'histogramme, le QQ_plot et le test de Shapiro (p-value=0.05), ils ne semblent pas suivre une loi gausienne.

Cette méthode nécéssite un traitement sur ses résidus.
...
Testons à présent des différantiation.
